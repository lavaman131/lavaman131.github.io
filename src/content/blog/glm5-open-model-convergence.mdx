...
cat .ralph/prompt.md | \
    claude -p --model glm-5 --output-format=stream-json \
...
- **Ecosystem adoption** — GLM-5 already supports Claude Code, OpenCode, Kilo Code, Roo Code, Cline, and Droid. Broader tool compatibility means lower switching costs
