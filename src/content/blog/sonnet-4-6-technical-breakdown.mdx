...
description: "Sonnet 4.6 scores within 1.2 points of Opus 4.6 on SWE-bench at roughly 60% of the cost. We break down the benchmarks, architecture changes, pricing math, developer reactions, and what it means for your agentic workflows."
cover: "../../assets/images/blog/sonnet-4-6-technical-breakdown/cover.png"
---
...
| Model | Input (per MTok) | Output (per MTok) | SWE-bench | Cost Ratio (per token) |
|---|---|---|---|---|
| **Claude Sonnet 4.6** | \$3 | \$15 | 79.6% (Verified) | **1x** |
| Claude Opus 4.6 | \$5 | \$25 | 80.8% (Verified) | ~1.7x |
| GPT-5.3 Codex | \$1.75 | \$14 | 56.8% (Pro) | ~0.9x |
| GPT-5.2 | \$1.75 | \$14 | 80.0% (Verified) | ~0.9x |
...
- [OpenAI GPT-5.3 Codex Announcement](https://openai.com/index/gpt-5-3-codex/)
