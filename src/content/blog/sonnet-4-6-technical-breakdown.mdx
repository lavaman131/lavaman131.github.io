...
<InteractiveMermaid chart={`
graph TD
    subgraph "SWE-bench Score per Dollar"
        S46["Sonnet 4.6<br/>79.6% @ \\$3/MTok<br/>26.5 pts/\\$"]
        O46["Opus 4.6<br/>80.8% @ \\$15/MTok<br/>5.4 pts/\\$"]
        GPT["GPT-5.2<br/>Lower @ \\$1.75/MTok"]
        GLM["GLM-5<br/>77.8% @ ~\\$0.15/MTok<br/>~519 pts/\\$"]
    end
    classDef best fill:#a6e3a1,stroke:#94e2d5,color:#000000
    classDef good fill:#89b4fa,stroke:#74c7ec,color:#000000
    classDef open fill:#f9e2af,stroke:#fab387,color:#000000
    classDef other fill:#cdd6f4,stroke:#bac2de,color:#000000
    class S46 best
    class O46 good
    class GLM open
    class GPT other
