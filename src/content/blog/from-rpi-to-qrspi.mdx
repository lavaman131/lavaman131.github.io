...
description: "Dex Horthy's Research-Plan-Implement was the first widely-adopted structured workflow for AI coding agents. Three failure modes forced a complete redesign into qRSPI. Here's what changed, what practitioners are validating, and what it reveals about where AI-assisted development is headed."
cover: "../../assets/images/blog/from-rpi-to-qrspi/cover.png"
---
...
flowchart LR
    subgraph Alignment["Alignment (before code)"]
        direction LR
        Q["<b>q</b><br/>Questions"]
        R["<b>R</b><br/>Research"]
        D["<b>D</b><br/>Design<br/>Discussion"]
        S["<b>S</b><br/>Structure<br/>Outline"]
        P["<b>P</b><br/>Plan"]
        Q --> R --> D --> S --> P
    end
